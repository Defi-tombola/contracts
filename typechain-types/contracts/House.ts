...
export interface HouseInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "lotteryProvider",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setLotteryProvider",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type PrizeDistributedEventFilter =
  TypedEventFilter<PrizeDistributedEvent>;
...
export interface House extends BaseContract {
  ...
  functions: {
    collectFee(
      ...
      lottery_owner: PromiseOrValue<string>,
    ...
    initialize(
      _lotteryProvider: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "PrizeDistributed(address,address,uint256)"(
      winner?: PromiseOrValue<string> | null,
      token?: PromiseOrValue<string> | null,
      amount?: null
    ): PrizeDistributedEventFilter;
    PrizeDistributed(
      winner?: PromiseOrValue<string> | null,
      token?: PromiseOrValue<string> | null,
      amount?: null
    ...
    "Recover(address,uint256)"(
      token_address?: PromiseOrValue<string> | null,
      token?: null
    ): RecoverEventFilter;
    Recover(
      token_address?: PromiseOrValue<string> | null,
